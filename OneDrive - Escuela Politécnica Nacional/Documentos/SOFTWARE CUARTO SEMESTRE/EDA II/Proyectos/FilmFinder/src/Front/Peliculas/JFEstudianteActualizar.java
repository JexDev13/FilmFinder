...
public class JFEstudianteActualizar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBResgistrar_estudiante.setBounds(70, 420, 110, 40);
        ...
        jChBNombre_ActualizarEst.setText("Nombre");
        ...
        jChBApellido_ActualizarEst.setText("Apellido");
        ...
        jChBSector_ActualizarEst.setText("Sector");
        ...
        jChBCelular_ActualizarEst.setText("Celular");
        ...
        jChBCorreo_ActualizarEst.setText("Correo");
        ...
        jChBFacultad_ActualizarEst.setText("Facultad");
                ...
                .addGroup(jPDatosEstudianteActualizarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPDatosEstudianteActualizarLayout.createSequentialGroup()
                        .addGroup(jPDatosEstudianteActualizarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jChBNombre_ActualizarEst, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
                    ...
                    .addGroup(jPDatosEstudianteActualizarLayout.createSequentialGroup()
                        .addComponent(jChBCelular_ActualizarEst, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(4, 4, 4)
                        .addComponent(jTFCelular_ActualizarEst, javax.swing.GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE))
                    .addGroup(jPDatosEstudianteActualizarLayout.createSequentialGroup()
                        .addGroup(jPDatosEstudianteActualizarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jChBSector_ActualizarEst, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jChBFacultad_ActualizarEst, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jChBCorreo_ActualizarEst, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(4, 4, 4)
                        .addGroup(jPDatosEstudianteActualizarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jButtonMinimizar1.setBackground(new java.awt.Color(91, 165, 152));
        jButtonMinimizar1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 0, new java.awt.Color(57, 116, 104)));
    ...
    private void jBResgistrar_estudianteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBResgistrar_estudianteActionPerformed
        if(this.jTFBuscar_ActualizarEst.getText().isEmpty()){
            ...
            String parametroBusqueda =this.jTFCodigo_ActualizarEst.getText();
            if(this.jChBNombre_ActualizarEst.isSelected()){atributosActualizar.add("'nombrePelicula'"+jTFNombres_ActualizarEst.getText()+"'");}
            if(this.jChBApellido_ActualizarEst.isSelected()){atributosActualizar.add("'Estreno'"+jTFApellidos_ActualizarEst.getText()+"'");}
            if(this.jChBSector_ActualizarEst.isSelected()){atributosActualizar.add("'idioma'"+jTFSector_ActualizarEst.getText()+"'");}
            if(this.jChBCelular_ActualizarEst.isSelected()){atributosActualizar.add("'PuntuacionSobre5'"+jTFCelular_ActualizarEst.getText()+"'");}
            if(this.jChBFacultad_ActualizarEst.isSelected()){atributosActualizar.add("'sinopsis"+jTFFacultad_ActualizarEst.getText()+"'");}
            if(this.jChBCorreo_ActualizarEst.isSelected()){atributosActualizar.add("'genero'"+jTFCorreo_ActualizarEst.getText()+"'");}
    ...
    private void jChBNombre_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBNombre_ActualizarEstActionPerformed
        if(jChBNombre_ActualizarEst.isSelected()){this.jTFNombres_ActualizarEst.setEditable(true);}
        else{this.jTFNombres_ActualizarEst.setEditable(false);}
    ...
    private void jChBApellido_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBApellido_ActualizarEstActionPerformed
        if(jChBApellido_ActualizarEst.isSelected()){this.jTFApellidos_ActualizarEst.setEditable(true);}
        else{this.jTFApellidos_ActualizarEst.setEditable(false);}
    ...
    private void jChBSector_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBSector_ActualizarEstActionPerformed
        if(jChBSector_ActualizarEst.isSelected()){this.jTFSector_ActualizarEst.setEditable(true);}
        else{this.jTFSector_ActualizarEst.setEditable(false);}
    ...
    private void jChBCelular_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBCelular_ActualizarEstActionPerformed
        if(jChBCelular_ActualizarEst.isSelected()){this.jTFCelular_ActualizarEst.setEditable(true);}
        else{this.jTFCelular_ActualizarEst.setEditable(false);}
    ...
    private void jChBCorreo_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBCorreo_ActualizarEstActionPerformed
        if(jChBCorreo_ActualizarEst.isSelected()){this.jTFCorreo_ActualizarEst.setEditable(true);}
        else{this.jTFCorreo_ActualizarEst.setEditable(false);}
    ...
    private void jChBFacultad_ActualizarEstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jChBFacultad_ActualizarEstActionPerformed
        if(this.jChBFacultad_ActualizarEst.isSelected()){this.jTFFacultad_ActualizarEst.setEditable(true);}
        else{this.jTFFacultad_ActualizarEst.setEditable(false);}
    ...
    private void jTFCorreo_ActualizarEstFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTFCorreo_ActualizarEstFocusLost
        String correo=this.jTFCorreo_ActualizarEst.getText();
    
        if(name.comprobarExpresionRegular(correo,"correo")==false){
            getToolkit().beep();


            this.jTFCorreo_ActualizarEst.requestFocus();
        }
    ...
    private void jTFBuscar_ActualizarEstKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFBuscar_ActualizarEstKeyReleased
        ...
        switch(select){
            case 0:{
                ...
                if(atributos.busquedaCod(tablaActualizar, SQL,columna)<1){
                    getToolkit().beep();

                }else{
                    this.SQL="SELECT * FROM " + tablaActualizar + " WHERE idPelicula like '%"+datoBusqueda+"%';";
                    atributos.despliegueFields(SQL,tablaActualizar,jTFCodigo_ActualizarEst,jTFNombres_ActualizarEst,jTFApellidos_ActualizarEst,
                        jTFCelular_ActualizarEst,jTFSector_ActualizarEst,jTFFacultad_ActualizarEst,jTFCorreo_ActualizarEst,null,"actualizar");
                }
                break;
            }
            case 1:{
