...
public class Conexion {
    ...
    public Connection conectar() {
        try {
            ...
            String password = "root"; //Aqui tienen que poner su contraseña SQL cuando clonen el repositorio
            String direccion = "jdbc:mysql://localhost:3306/filmfinder"; //proyecto1 es la base de datos, esa se debe guardar en la conexion de sql
